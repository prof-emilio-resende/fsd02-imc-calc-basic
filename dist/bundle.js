...
var proxy = __webpack_require__(5607);
var proxy_default = /*#__PURE__*/__webpack_require__.n(proxy);
...
var ViewComponent = /*#__PURE__*/function () {
  function ViewComponent() {
    ...
    console.log("initializing the ViewComponent... ".concat(this.__proto__.constructor.name));
    this.state = {};
...
;// CONCATENATED MODULE: ./src/domain/Person.js
...
var Person = /*#__PURE__*/function () {
  function Person(theHeight, theWeight) {
    ...
    if (typeof theHeight !== "number" || isNaN(theHeight)) throw Error("height is not a number");
    if (typeof theWeight !== "number" || isNaN(theWeight)) throw Error("height is not a number");
    if (theHeight <= 0 || theWeight <= 0) throw Error("height and weight must be bigger than zero");
  ...
  _createClass(Person, [{
    ...
    set: function set(theImcDescription) {
...
var ImcView = /*#__PURE__*/function (_ViewComponent) {
  ...
  var _super = _createSuper(ImcView);
  ...
  _createClass(ImcView, [{
    key: "updateState",
    value: function updateState(state) {
      var newState = _objectSpread(_objectSpread({}, this.state), state);

      _get(_getPrototypeOf(ImcView.prototype), "updateState", this).call(this, newState);
    }
  }, {
    key: "render",
    value: function render() {
      return '<div class="result">' + '<label>Seu IMC &eacute;:</label>' + "".concat(this.state.person.imc, "&nbsp;<span id=\"imc\">") + "".concat(this.state.person.imcDescription, "</span>") + '</div>';
    }
  }]);
...
var HttpUtil = /*#__PURE__*/function () {
  ...
  _createClass(HttpUtil, [{
    key: "createRequest",
    value: function createRequest(method) {
    ...
    key: "post",
    value: function post(hostname, url, obj) {
      var req = this.createRequest("POST", obj);
      return fetch("".concat(hostname).concat(url), req);
    }
  }]);
...
var ImcDriver = /*#__PURE__*/function () {
  ...
  _createClass(ImcDriver, [{
    key: "calculate",
    value: function () {
      var _calculate = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(person) {
        var response;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.xhr.post("http://localhost:8080", "/imc/calculate", person.toObj());
...
;// CONCATENATED MODULE: ./src/controller/ImcController.js
        ...
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.imcDriver.calculate(person);
...
(function () {
  ...
  function buildCalculateImc() {
    ...
    var state = imcView.observe({
      person: new Person(0.1, 0.1)
    });
    return /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(evt) {
        var weight, height, p, personResult;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log(evt);
                weight = parseFloat(weightElement.value);
                height = parseFloat(heightElement.value);
                p = new Person(height, weight);
                _context.next = 6;
                return imcController.calculate(p);
